...
@Entity
@Table(name = "DATA_EXPORT_ID_PK")
public class DataExportIdPkEntryEntity {
    ...
    @Id
    @GeneratedValue(strategy=GenerationType.SEQUENCE, generator="dataExportIdPkSeq")
    @SequenceGenerator(name="dataExportIdPkSeq", sequenceName="DATA_EXPORT_ID_PK_SEQ", allocationSize=10000)
    @Column(name = ID_PK)
     ...
     */
    public DataExportIdPkEntryEntity() {
    }
