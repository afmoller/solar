...
public class EnergyCostEntry {
     ...
     */
    public EnergyCostEntry() {
    }

    private EnergyCostEntry(EnergyCostEntryBuilder energyCostEntryBuilder) {
    ...
    public static class EnergyCostEntryBuilder {
        ...
        public EnergyCostEntry build() {
            return new EnergyCostEntry(this);
        }
    }
}
