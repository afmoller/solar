...
public class ReturnOnInvestmentEntry {
     ...
     */
    public ReturnOnInvestmentEntry() {
    }

    private ReturnOnInvestmentEntry(ReturnOnInvestmentEntryBuilder returnOnInvestmentEntryBuilder) {
    ...
    public static class ReturnOnInvestmentEntryBuilder {
        ...
        public ReturnOnInvestmentEntry build() {
            return new ReturnOnInvestmentEntry(this);
        }
    }
}
