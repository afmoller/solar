...
public class EnergySaleCompensationEntry {
     ...
     */
    public EnergySaleCompensationEntry() {
    }

    private EnergySaleCompensationEntry(EnergySaleCompensationEntryBuilder returnOnInvestmentEntryBuilder) {
    ...
    public static class EnergySaleCompensationEntryBuilder {
        ...
        public EnergySaleCompensationEntry build() {
            return new EnergySaleCompensationEntry(this);
        }
    }
}
